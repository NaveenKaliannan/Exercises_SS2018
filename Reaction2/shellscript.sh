...
for a in {01..14} ; do tail -n 2938 NEB-pos-Replica_nr_${a}-1.xyz >> movie.xyz ; done 
for a in {01..14} ; do grep ENERGY  NEB-BAND${a}.out | tail -n 1 | awk '{print '${a}',$9}' ; done > neb_profile 
